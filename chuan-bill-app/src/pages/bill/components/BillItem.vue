...
<template>
  ...
  >
    <view class="flex flex-1 gap-4">
      <!-- 左侧：图标 -->
      <view
        class="h-5 w-5 flex items-center justify-center border-[1px] border-white/30 rounded-full border-solid bg-[rgba(255,255,255,0.2)] p-3 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[16px] backdrop-saturate-[180%]"
